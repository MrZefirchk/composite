public class Main {
    public static void main(String[] args){
        ...
        Manager ceo = null;
        try{
            ceo = new Manager("John", "Snow", 5500, 210, 0);
            ceo.printemployee();
            hr.addWorker(ceo);
        ...
        try{
            salesHead = new Employee("Clara", "Polson", 3000, ceo.id);
        ...
        try{
            marketingHead = new Employee("Kite", "Longreed", 1500, ceo.id);
        ...
        Employee emp1 = null;
        try{
            emp1 = new Employee("Brett", "Sorrow", 1000, salesHead.id);
            emp1.printemployee();
            hr.addWorker(emp1);
        } catch (FieldLengthLimitException e){
            System.out.println(e.getMessage());
